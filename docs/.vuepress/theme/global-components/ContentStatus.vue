      ...
      <div class="content-status-all">
        <div>
          <div v-if="issueUrl" class="content-status-status">
            <p>
              <a target="_blank" :href="issueUrl">Check the status</a> how it's coming along? <a target="_blank" :href="issueUrl">Help write this page!</a>
            </p>
          </div>
          <div class="section content-status-vote">
            <Feedback
              titleTxt="Maybe available 2022 Q1"
              :editOrIssueLinks="false"
            />
          </div>
        </div>
        <div class="illustration">
          <img src="../assets/timeout.svg" />
        </div>
      </div>
    </div>
