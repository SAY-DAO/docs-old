...
const DEPLOY_DOMAIN = 'https://say-dao.org'
const pageSuffix = '/'
...
module.exports = {
  ...
  themeConfig: {
    ...
    keywords:
      'Filecoin, Defi, social, poverty, dao, non-fungible token, nonfungible token, IPFS, dapp',
    // edit links
    ...
    docsBranch: 'main',
    feedbackWidget: {
      docsRepoIssue: 'SAY-DAO/road-map-docs'
    },
    editLinks: false,
    // page nav
    nextLinks: false,
